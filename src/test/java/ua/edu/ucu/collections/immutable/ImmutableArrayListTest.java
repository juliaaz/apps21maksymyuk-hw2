...
public class ImmutableArrayListTest {
    ...
    public void testAppend() {
        ImmutableList list = new ImmutableArrayList().add(1);
        assertArrayEquals(new Object[] {1}, list.toArray());
    }

    @Test
    public void testInsert() {
        ImmutableList list = new ImmutableArrayList().add(1).add(2).add(3).add(2, 4);
        assertArrayEquals(new Object[] {1, 2, 4, 3}, list.toArray());
    }

    @Test
    public void testAppendAll() {
        ImmutableList list = new ImmutableArrayList().add(1).add(2).add(3).addAll(new Object[] {4, 5, 6});
    ...
    public void testInsertAll() {
        ImmutableList list = new ImmutableArrayList().add(1).add(2).add(3).addAll(2, new Object[] {4, 5, 6});
    ...
    public void testRemove() {
        ...
        ImmutableList list = new ImmutableArrayList().add(1).add(2).add(3).add(4).remove(3);
    ...
    @Test
    public void testSet() {
        ImmutableList list = new ImmutableArrayList().add(1).add(2).add(3).set(2, 4);
        assertArrayEquals(new Object[] {1, 2, 4}, list.toArray());
    }

    @Test
    public void testIndexOf() {
        ImmutableList list = new ImmutableArrayList().add(1).add(2).add(3);
    ...
    public void testClear() {
        ImmutableList list = new ImmutableArrayList().add(1).add(2).add(3).clear();
